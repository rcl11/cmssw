...
class DoubleElectronHLTMatching : public edm::EDProducer {
public:
  explicit DoubleElectronHLTMatching(const edm::ParameterSet&);
  ~DoubleElectronHLTMatching();
...
DoubleElectronHLTMatching::DoubleElectronHLTMatching(const edm::ParameterSet& iConfig) {
...
DoubleElectronHLTMatching::~DoubleElectronHLTMatching() 
{}

void DoubleElectronHLTMatching::produce(edm::Event& iEvent, const edm::EventSetup& iSetup) {
...
template <class T1, class T2> 
std::vector<int> DoubleElectronHLTMatching::matchByDeltaR(const std::vector<T1> & collection1, 
...
trigger::TriggerObjectCollection DoubleElectronHLTMatching::selectTriggerObjects(const trigger::TriggerObjectCollection & triggerObjects,
...
reco::GsfElectronCollection DoubleElectronHLTMatching::selectElectrons(const reco::GsfElectronCollection& allElectrons, 
...
DEFINE_FWK_MODULE(DoubleElectronHLTMatching);
